...
class UNet(nn.Module):
    def __init__(self, n_channels, shrink):
        ...
        self.down2 = down(128 // shrink, 128 // shrink)
        self.down3 = down(128 // shrink, 256 // shrink)
        self.down4 = down(256 // shrink, 256 // shrink)
        self.up1 = up(512 // shrink, 128 // shrink)
        self.up2 = up(256 // shrink, 128 // shrink)
